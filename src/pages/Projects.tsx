                ...
                {section.items.map((project, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className={`absolute top-3 left-3 text-xs tracking-label uppercase font-semibold px-2 py-1 bg-white bg-opacity-90 ${statusColors[project.status ?? 'ongoing']}`}>
                        {t.statusLabels[project.status ?? 'ongoing']}
                      </span>
                    </div>
