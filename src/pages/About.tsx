...
export default function About() {
  ...
  const valueRows = [
    ...
    { labelKey: 'projects' as const, value: '8' },
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 border-b border-black">
        ...
        {/* Right: timeline from Contentful */}
        <div className="px-8 py-12">
          ...
          {!milestonesLoading && milestones.length === 0 && (
            <p className="text-xs tracking-label uppercase text-gray-400">No milestones yet.</p>
          )}
